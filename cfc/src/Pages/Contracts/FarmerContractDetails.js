        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-green-100 text-sm">Negotiate terms with the buyer</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-gray-50 rounded-xl p-3">
                ...
                <p className="text-sm font-medium text-gray-700 mt-0.5 truncate">{contract.buyerName || contract.buyerEmail}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-3">
                <p className="text-xs text-gray-400 uppercase tracking-wide">Buyer Email</p>
                <p className="text-sm font-medium text-gray-700 mt-0.5 truncate">{contract.buyerEmail}</p>
              </div>
              <div className="bg-gray-50 rounded-xl p-3">
            ...
            <div className="mt-3 bg-gray-50 rounded-xl p-3 inline-block">
          ...
          <div className="px-6 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-medium text-gray-600">You {farmerHasDone ? '(Done)' : '(Pending)'}</span>
              </div>
              <div className="flex items-center gap-2">
                <div className={`w-3 h-3 rounded-full ${buyerHasDone ? 'bg-green-500' : 'bg-gray-300'}`}></div>
                <span className="text-xs font-medium text-gray-600">Buyer {buyerHasDone ? '(Done)' : '(Pending)'}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-100">
            ...
            <p className="text-sm text-gray-400">Discuss terms and finalize details with the buyer</p>
          </div>
          <div className="p-4">
            <ChatBox
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          {overallStatus === 'Negotiation Done' && farmerHasDone && buyerHasDone && (
            <div className="flex items-center gap-3 p-4 bg-emerald-50 rounded-xl border border-emerald-100 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-emerald-600">Both parties agreed. You can now create the final contract.</p>
              </div>
            </div>
          )}
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className={`px-5 py-2.5 rounded-xl font-medium flex items-center gap-2 transition-all ${farmerHasDone
            ...
            >
              ...
              {farmerHasDone ? 'You marked Done' : 'Negotiation Done'}
            </button>
            ...
            {contract.status === 'Negotiation Done' && (
              <button
                onClick={() => navigate('/create-final-contract', { state: { contract } })}
                className="px-5 py-2.5 rounded-xl font-medium bg-blue-600 text-white hover:bg-blue-700 transition-all flex items-center gap-2"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
