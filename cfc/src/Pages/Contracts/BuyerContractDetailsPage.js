    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-100 py-3 px-6">
        <div className="max-w-4xl mx-auto flex items-center gap-2 text-sm">
          <Link to="/buyer/final-contracts" className="text-green-600 hover:text-green-700 font-medium flex items-center gap-1">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <button
              onClick={() => navigate(`/buyer/contract-agreement/${id}`)}
