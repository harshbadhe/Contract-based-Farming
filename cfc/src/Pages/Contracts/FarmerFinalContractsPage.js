        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              ...
              <p className="text-green-100 text-sm">Blockchain-verified smart contracts for your produce</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {contracts.map((c) => {
              ...
              return (
                <div
                  key={c.id}
                  onClick={() => navigate(`/farmer/contract/${c.id}`)}
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-400">
                      ...
                      <span className="truncate">Buyer: {c.buyerWallet}</span>
                    </div>
                  </div>
...
export default FarmerFinalContractsPage;
